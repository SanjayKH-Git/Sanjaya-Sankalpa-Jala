    ...
    <div className="w-full lgl:w-[35%] h-full bg-gradient-to-r from-[#1e2024] to-[#23272b] p-4 lgl:p-8 rounded-lg shadow-shadowOne flex flex-col gap-5 justify-center">
      ...
      <div className="flex flex-col gap-1">
        ...
        <p className="text-base text-gray-400 tracking-wide">
          You can Contact Me at any time asynchronously. Reach out Me @ <a href="https://www.linkedin.com/in/sanjay-krishna-hegade-19216915b/" target="_blank" rel="noopener noreferrer" className='font-bold text-blue-400'>Linked in chat</a> for Quik Response.
        </p>
